import pygame, sys
from configurations import screen_width, screen_height, levels,\
    create_stats_json
...
create_stats_json()
current_time = 0
main_menu = MainMenu(screen,0,0,screen_width,screen_height,"black","black",1,False)
lvl_menu = LevelMenu(screen,0,0,screen_width,screen_height,"black","black",1,False)
pause_menu = PauseMenu(screen,0,0,screen_width,screen_height,"black","black",1,False)
settings_menu = Settings(screen,0,0,screen_width,screen_height,"black","black",1,False)
stats_screen = StatsScreen(screen,0,0,screen_width,screen_height,"black","black",1,False)
htp_menu = HowToPlayMenu(screen,0,0,screen_width,screen_height,"black","black",1,False)
lvl_form = ''
lvl_selected = ''
